...
class Dozen(models.Model):
    ...
    model = models.ForeignKey(Model, related_name='dozens', on_delete=PROTECT, verbose_name='Modelo')
    size = models.ForeignKey(Sizes, related_name='dozens', on_delete=PROTECT, verbose_name='Talla')
    material = models.CharField(max_length=30, choices=material_choices, default='cuero', verbose_name='Material')
    color = models.CharField(max_length=30, choices=colors_choices, verbose_name='Color')
    status = models.CharField(max_length=30, choices=statuses_choices, default='disponible', verbose_name='Estado')
...
class DozensOfCortadores(models.Model):
    ...
    user = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='cortadores', on_delete=PROTECT,
...
class DozensOfAparadores(models.Model):
    ...
    user = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='aparadores', on_delete=PROTECT,
...
class DozensOfArmadores(models.Model):
    ...
    user = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='armadores', on_delete=PROTECT,
...
class DozensOfRematadoras(models.Model):
    ...
    user = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='rematadoras', on_delete=PROTECT,
                             verbose_name='Rematadoras')
    note = models.TextField(max_length=250, blank=True, verbose_name='Nota')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creacion')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='Fecha de actualizacion')
